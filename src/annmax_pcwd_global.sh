...
Rscript 03_get_pcwd_annmax_ModESim_ubelix.R 1 1   # call without any command line arguments, if you overwrite them anyway in the R script with 'args <- c(1,1)'
