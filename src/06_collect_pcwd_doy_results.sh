#! /usr/bin/bash -l
#SBATCH --job-name="collect PCWD annmax doy 1420 set"
...
Rscript 06_collect_pcwd_doy_ModESim.R   # call without any command line arguments, if you overwrite them anyway in the R script with 'args <- c(1,1)'
