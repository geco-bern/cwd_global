...
OUTPUT_DIR="/storage/research/giub_geco/data_2/scratch/phelpap/ERA5Land_1950-2024/ERA5Land_regridded/Monthly_ssr"
...
for file in "$INPUT_DIR"/ERA5Land_UTCDaily.tot_ssr.*.nc; do
    [ -e "$file" ] || continue
    ...
    echo "Processed: $filename → $monthly_output_file"
done
