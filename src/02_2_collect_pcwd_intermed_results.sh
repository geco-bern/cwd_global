#! /usr/bin/bash -l
#SBATCH --job-name="PCWD intermed results 1850 set"
...
Rscript 02_2_collect_pcwd_intermed_ModESim.R   # call without any command line arguments, if you overwrite them anyway in the R script with 'args <- c(1,1)'
