#! /usr/bin/bash -l
#SBATCH --job-name="Extract p,pet,pcwd 1420 set"
...
Rscript Get_total_Precip_ModESim_ubelix.R 1 1   # call without any command line arguments, if you overwrite them anyway in the R script with 'args <- c(1,1)'
