#! /usr/bin/bash -l
#SBATCH --job-name="PCWD annmax DOY 1420 set"
...
Rscript 05_get_pcwd_annmax_doy_ModESim_ubelix.R 1 1   # call without any command line arguments, if you overwrite them anyway in the R script with 'args <- c(1,1)'
