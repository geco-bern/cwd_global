#! /usr/bin/bash -l
#SBATCH --job-name="collect daily pwcd"
...
Rscript Collect_total_Prec_ModESim.R   # call without any command line arguments, if you overwrite them anyway in the R script with 'args <- c(1,1)'
