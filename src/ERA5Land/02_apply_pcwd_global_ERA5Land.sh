#! /usr/bin/bash -l
#SBATCH --job-name="ERA5Land files"
...
Rscript 02_apply_pcwd_global_ERA5Land_ubelix.R 1 1   # call without any command line arguments, if you overwrite them anyway in the R script with 'args <- c(1,1)'
