#! /usr/bin/bash -l
#SBATCH --job-name="collect PCWD annmax ERA5Land"
...
Rscript 04_collect_pcwd_results_ERA5Land.R   # call without any command line arguments, if you overwrite them anyway in the R script with 'args <- c(1,1)'
