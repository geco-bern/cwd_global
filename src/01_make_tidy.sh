#! /usr/bin/bash -l
#SBATCH --job-name="tidy m015 1420"
...
Rscript 01_make_tidy_ModESim.R   # call without any command line arguments, if you overwrite them anyway in the R script with 'args <- c(1,1)'
