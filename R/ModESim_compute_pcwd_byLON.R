...
ModESim_compute_pcwd_byLON <- function(
  ...
  indir_patm      <- file.path(indir, "1850_01_m001_patm")
  indir_tas       <- file.path(indir, "1850_01_m001_tsurf")
  indir_prec      <- file.path(indir, "1850_01_m001_precip")
  indir_netrad    <- file.path(indir, "1850_01_m001_netrad")
  ...
  filnam <- file.path(indir_patm, paste0("set1850_1_m001_patm_",
                                            LON_string,".rds"))
  df_patm <- readr::read_rds(filnam)


  # read precipitation file tidy
  filnam <- file.path(indir_prec, paste0("set1850_1_m001_precip_",
                                         LON_string,".rds"))
  df_prec <- readr::read_rds(filnam)


  # read temperature file tidy
  filnam <- file.path(indir_tas, paste0("set1850_1_m001_tsurf_",
                                         LON_string,".rds"))
  df_tas <- readr::read_rds(filnam)


  # read net radiation file tidy
  filnam <- file.path(indir_netrad, paste0("set1850_1_m001_netrad_",
                                        LON_string,".rds"))
