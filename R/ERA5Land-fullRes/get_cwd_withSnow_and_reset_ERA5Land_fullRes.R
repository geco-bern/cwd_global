get_cwd_withSnow_and_reset_ERA5Land <- function(vars_df){
  ...
  # devtools::load_all("~/Era5_pcwd/cwd_global/R/ERA5Land-fullRes/ERA5_simulate_snow.R")
  ...
  vars_df <- vars_df |>
    ...
    ERA5_simulate_snow_fullRes(varnam_prec = "precipitation", varnam_snow = "snow", varnam_temp = "tsurf")
