...
indir        <- "/storage/research/giub_geco/data_2/scratch/phelpap/ERA5Land_1950-2024/03_pcwd_ANNMAX"
outfile_pcwd <- "/storage/research/giub_geco/data_2/scratch/phelpap/ERA5Land_1950-2024/04_result/PCWD_ANNMAX" # adjust path to where the file should be written to


# 1) Define filenames of files to collect:  -------------------------------
filnams_pcwd <- list.files(indir, pattern = "ERA5Land_pcwd_(LON_[0-9.+-]*)_ANNMAX.rds", full.names = TRUE)
...
rgeco::write_nc2(
  ...
  att_title      = "Global Potential Cumulative Water Deficit for ERA5Land data",
  att_history    = sprintf(
