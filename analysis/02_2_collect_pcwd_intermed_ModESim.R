...
indir       <- "/storage/research/giub_geco/data_2/scratch/phelpap/ModESim/m001_tidy/02_1_pcwd_1420_AbsTrsh"
outfile_pcwd <- "/storage/research/giub_geco/data_2/scratch/phelpap/ModESim/m001_tidy/02_2_pcwd_result_1420_AbsTrsh/PCWD_maxlen" # adjust path to where the file should be written to
