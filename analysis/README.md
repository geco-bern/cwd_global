...
Easiest is to run it on UBELIX by submitting the bash script `analysis/ERA5Land-fullRes/main.sh`: `ssh ubelix; cd GitHub/geco-bern/cwd_global/; sbatch analysis/ERA5Land-fullRes/main.sh`.
