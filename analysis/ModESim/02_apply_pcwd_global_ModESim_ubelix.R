...
outdir <- "/storage/research/giub_geco/data_2/scratch/phelpap/ModESim/m030_tidy/02_pcwd_1420"
...
filnams <- list.files(file.path(indir, "1420_02_m030_precip"),  # use precip folder as example; change year
