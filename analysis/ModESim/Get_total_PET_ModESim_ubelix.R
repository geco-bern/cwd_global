...
outdir  <- "/storage/research/giub_geco/data_2/scratch/phelpap/ModESim/m020_tidy/Total_PET_1420"
...
source("/storage/homefs/ph23v078/cwd_global/R/ModE-Sim/get_totalPET_byLON.R")
...
cl <- multidplyr::new_cluster(ncores) |>
  ...
  multidplyr::cluster_assign(
    indir       = indir,
    outdir      = outdir,
    extract_totalPET = extract_totalPET,
    get_totPET_byLON = get_totPET_byLON,   # make the function known for each core
  )
