...
outdir  <- "/storage/research/giub_geco/data_2/scratch/phelpap/ModESim/m020_tidy/Total_P_1420"
...
source("/storage/homefs/ph23v078/cwd_global/R/ModE-Sim/get_totalPrec_byLON.R")
...
cl <- multidplyr::new_cluster(ncores) |>
  ...
  multidplyr::cluster_assign(
    indir       = indir,
    outdir      = outdir,
    extract_totalPrec = extract_totalPrec,
    get_totPrec_byLON = get_totPrec_byLON,   # make the function known for each core
  )
