...
Russia_AT_df <- data.frame(time_AT, Russia_1850_AT, Russia_1850)
...
# Prepend NAs to the shorter list
Algeria_AT_df <- data.frame(time_AT, Algeria_1850_AT, Algeria_1850)
...
# Prepend NAs to the shorter list
Antarctica_AT_df <- data.frame(time_AT, Antarctica_1850_AT, Antarctica_1850)
...
# Prepend NAs to the shorter list
Czechia_AT_df <- data.frame(time_AT, Czechia_1850_AT, Czechia_1850)
...
# Prepend NAs to the shorter list
Brazil_AT_df <- data.frame(time_AT, Brazil_1850_AT, Brazil_1850)
...
Algeria <- ggplot() +
  ...
  scale_color_manual(values = c("Russia 1850_AT" = "red", "Russia 1850" = "darkred","Algeria 1850_AT" = "deepskyblue", "Algeria 1850" = "deepskyblue4", "Antarctica 1850_AT" = "darkslategray4", "Antarctica 1850" = "darkslategray", "Brazil 1850_AT" = "green", "Brazil 1850" = "darkgreen", "Czechia 1850_AT" = "yellow", "Czechia 1850" = "gold"))
