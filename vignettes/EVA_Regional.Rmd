...
ggplot() +
  ...
  geom_sf_text(data = region_labels, aes(label = label), size = 2.3, color = "black", check_overlap = FALSE) +  # Add region names
  scale_fill_manual(values = continent_colors, name = "Continent") +
  theme_minimal() +
  labs(x= "", y="", title = "Map of IPCC Regions by Continent",
