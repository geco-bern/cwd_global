...
for (region in names(regional_results_1850)) { #swap european_regions for regional_results for all regions
  ...
  # Calculate magnitude of event with RP = X in reference period - same baseline as for 1420 epoch
...
#time_series_plot <- 
  ggplot(combined_df_sel, aes(x = time, y = RP), color="black") +
  geom_line() +  # Plot lines for each region's return period
  geom_hline(yintercept = 2, linetype = "dashed", color = "grey40") +   # Add a reference line for 2-year return period
  labs(
    x = "Year",
...
#time_series_plot_A <- 
  ...
  theme(
    ...
    legend.title = element_text(face = "bold"),
    plot.title = element_text(hjust = 0.5, face = "bold"),
    strip.text = element_text(size = 18),  # Size for facet labels
...
ggplot(data_first_last, aes(x = year_1834, y = year_1435, color = continent)) +
  ...
  scale_x_continuous(limits = c(0, NA)) +  # Ensures x-axis starts from 0
  scale_y_continuous(limits = c(0, NA)) +  # Ensures y-axis starts from 0
  theme_classic()
...
#time_series_plot <- 
  ggplot(combined_df_sel, aes(x = time, y = RP), color="black") +
  geom_line() +  # Plot lines for each region's return period
  geom_hline(yintercept = 20, linetype = "dashed", color = "grey40") +   # Add a reference line for 2-year return period
  labs(
    x = "Year",
    y = "Effective Return Period",
...
# Define bounding box for N America
#bbox <- c(xmin = -140, xmax = -10, ymin = 20, ymax = 90)  # Approximate bounding box for Oceania
...
#time_series_plot <- 
  ggplot(combined_df_sel, aes(x = time, y = RP), color="black") +
  geom_line() +  # Plot lines for each region's return period
  geom_hline(yintercept = 100, linetype = "dashed", color = "grey40") +   # Add a reference line for 2-year return period
  labs(
    x = "Year",
    y = "Effective Return Period",
...
# 
# # Define bounding box for Asia
# bbox <- c(xmin = 30, xmax = 190, ymin = -100, ymax = 90)  # Approximate bounding box for Europe
# 
# # european_regions_sf <- refregions_sf %>% filter(continent == "Europe")
# # # Define the bounding box for Europe
# # europe_bbox <- c(xmin = -30, xmax = 70, ymin = 25, ymax = 75)  # Approximate bounding box for Europe
...
ggplot(combined_df_sel, aes(x = time, y = RP), color="black") +
  ...
  theme(
    ...
    legend.title = element_text(face = "bold"),
    plot.title = element_text(hjust = 0.5, face = "bold"),
    strip.text = element_text(size = 18, color = "white"),  # Size for facet labels
    axis.text.x = element_text(angle = 45, hjust = 1, size = 18),
    axis.text.y = element_text(size = 18), 
    axis.title.x = element_text(size = 18),
    axis.title.y = element_text(size = 18),
...
# Define bounding box for N America
#bbox <- c(xmin = -180, xmax = -10, ymin = 100, ymax = 90)  # Approximate bounding box for Oceania
...
# Define bounding box for N America
#bbox <- c(xmin = -140, xmax = -10, ymin = 100, ymax = 90)  # Approximate bounding box for Oceania
