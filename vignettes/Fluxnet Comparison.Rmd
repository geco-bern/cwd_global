...
used lon 155 from cmip data and lat 50/51.
...
deficit_cwd <- readRDS("/data_1/CMIP6/tidy/cwd/cwd_155.rds")
deficit_pcwd <- readRDS("/data_1/CMIP6/tidy/pcwd/pcwd_155.rds")
